...
**Ressources :** [OCRmyPDF docs](https://ocrmypdf.readthedocs.io/en/latest/) ; [Tesseract Windows](https://github.com/UB-Mannheim/tesseract/wiki) ; Stack Overflow pour TESSDATA_PREFIX.
